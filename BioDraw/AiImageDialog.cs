...
namespace BioDraw
{
    internal sealed class AiImageDialog : Form
    {
        ...
        public AiImageDialog(AiImageApiSettings settings, List<AiImageApiSettings> allSettings,
        ...
        private void form_Resize()
        {
            ...
            var buttonHeight = 40;
            var fieldGap = 8;
            // Measure the widest label text at the current font/DPI rather than hardcoding
            ...
            // Each pair of label+combo occupies half the row; combo takes the rest of its half
            var totalFieldWidth = rightEdge - fieldX;
            var halfWidth = totalFieldWidth / 2;
            // comboWidth: at least 140px, fills its half minus gap for the second column
        ...
        private void OnGenerateClick(object sender, EventArgs e)
        {
            ...
            Task.Run(() =>
            {
                string outputPath;
                string error;
                var success = AiImageService.TryGenerateImage(_settings, prompt, width, height, quality, format,
